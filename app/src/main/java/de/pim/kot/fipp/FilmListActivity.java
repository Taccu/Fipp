...
import de.pim.kot.fipp.dummy.DummyContent;
...
public class FilmListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.film_list);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(FilmDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(FilmDetailFragment.ARG_ITEM_ID, holder.mItem.id);
